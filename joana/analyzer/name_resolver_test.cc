...
TEST_F(NameResolverTest, ComputedMemberExpression) {
  EXPECT_EQ(
      ...
      "|  |  +--JsDocText |*/|\n"
      "|  +--ExpressionStatement\n"
      "|  |  +--ComputedMemberExpression PublicProperty[Symbol.iterator@1008]\n"
      "|  |  |  +--ReferenceExpression FunctionVar[Foo@1006]\n"
      "|  |  |  |  +--Name |Foo|\n"
      "|  |  |  +--MemberExpression PublicProperty[iterator@1007]\n"
      "|  |  |  |  +--ReferenceExpression FunctionVar[Symbol@1003]\n"
      "|  |  |  |  |  +--Name |Symbol|\n"
      "|  |  |  |  +--Name |iterator|\n",
...
TEST_F(NameResolverTest, MemberExpression) {
  EXPECT_EQ(
      ...
      "|  |  |  |  +--ReferenceExpression FunctionVar[Foo@1003]\n"
      "|  |  |  |  |  +--Name |Foo|\n"
      "|  |  |  |  +--Name |prototype|\n"
      "|  |  |  +--Name |bar|\n",
...
TEST_F(NameResolverTest, Type) {
  EXPECT_EQ(
      ...
      "|  |  +--JsDocText |*/|\n"
      "|  +--VarStatement\n"
      "|  |  +--BindingNameElement VarVar[foo@1003]\n"
      "|  |  |  +--Name |foo|\n"
      "|  |  |  +--ElisionExpression ||\n",
