...
# found in the LICENSE file.
{
    'variables': {
      'js_defs_files': [
        ...
        'dom/windows/window_enums.js',
      ],
      'js_externs_files': [
        'dom/errors_externs.js',
        'dom/types_externs.js',
        'dom/bracket_externs.js',
        'dom/clipboard/data_transfer_externs.js',
        'dom/clipboard/data_transfer_item_externs.js',
        'dom/clipboard/data_transfer_item_list_externs.js',
        'dom/commander_externs.js',
        'dom/commands/find_and_replace_externs.js',
        'dom/commands/spell_checker_externs.js',
        'dom/console_externs.js',
        'dom/text/document_externs.js',
        'dom/windows/document_window_externs.js',
        ...
        'dom/windows/editor_window_externs.js',
        ...
        'dom/text/modes/modes_externs.js',
        'dom/text/mutation_observer_externs.js',
        'dom/os/file_externs.js',
        'dom/os/process_externs.js',
        'dom/windows/point_externs.js',
        'dom/text/range_externs.js',
        'dom/text/regexp_externs.js',
        'dom/windows/document_state_externs.js',
        'dom/windows/selection_externs.js',
        'dom/css/style_externs.js',
        'dom/windows/table_selection_externs.js',
        'dom/windows/table_window_externs.js',
        'dom/windows/tab_data_externs.js',
        'dom/text/text_position_externs.js',
        'dom/windows/text_selection_externs.js',
        'dom/windows/text_window_externs.js',
        'dom/timer_externs.js',
        'dom/windows/window_externs.js',
      ...
      'js_lib_files': [
        ...
        'dom/bracket.js',
        'dom/commander.js',
        'dom/text/document.js',
        'dom/editor.js',
        'dom/windows/editor_window.js',
        ...
        'dom/text/regexp.js',
        'dom/css/style.js',
        'dom/windows/table_window.js',
        'dom/text/text_position.js',
        'dom/windows/document_state.js',
        'dom/windows/tab_data.js',
        'dom/windows/text_selection.js',
        'dom/windows/text_window.js',
        'dom/windows/window.js',
        ...
        'dom/commands/find_and_replace.js',
        'dom/commands/find_and_replace_commands.js',
        'dom/commands/spell_checker.js',
  ...
  'targets': [
...

    {
      ...
      'sources': [
        ...
        'dom/text/buffer.cc',
        'dom/converter.cc',
        'dom/text/document.cc',
        'dom/text/document_set.cc',
        ...
        'dom/events/view_event_handler_impl.cc',
        ...
        'dom/text/modes/config_mode.cc',
        'dom/text/modes/cxx_mode.cc',
        'dom/text/modes/haskell_mode.cc',
        'dom/text/modes/java_mode.cc',
        'dom/text/modes/javascript_mode.cc',
        'dom/text/modes/lisp_mode.cc',
        'dom/text/modes/mason_mode.cc',
        'dom/text/modes/perl_mode.cc',
        'dom/text/modes/plain_text_mode.cc',
        'dom/text/modes/python_mode.cc',
        'dom/text/modes/xml_mode.cc',

        'dom/text/mutation_observer.cc',
        'dom/text/mutation_observer_controller.cc',
        'dom/text/mutation_observer_init.cc',
        'dom/text/mutation_record.cc',
        ...
        'dom/windows/table_selection.cc',
        'dom/windows/text_selection.cc',
        'dom/windows/text_window.cc',
        'dom/timer.cc',
        'dom/time_stamp.cc',
