...
#ifndef EVITA_VISUALS_VIEW_PUBLIC_SELECTION_OBSERVER_H_
#define EVITA_VISUALS_VIEW_PUBLIC_SELECTION_OBSERVER_H_
...
#endif  // EVITA_VISUALS_VIEW_PUBLIC_SELECTION_OBSERVER_H_
