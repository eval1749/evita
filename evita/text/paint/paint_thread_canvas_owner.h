...
#ifndef EVITA_TEXT_PAINT_PAINT_THREAD_CANVAS_OWNER_H_
#define EVITA_TEXT_PAINT_PAINT_THREAD_CANVAS_OWNER_H_
...
#endif  // EVITA_TEXT_PAINT_PAINT_THREAD_CANVAS_OWNER_H_
