...

{
  'variables': {
    ...
    'generated_glue_files': [
      ...
      '<(glue_dir)/CompositionEvent.cc',
      '<(glue_dir)/CompositionEvent.h',
      '<(glue_dir)/CompositionEventInit.cc',
      '<(glue_dir)/CompositionEventInit.h',
      '<(glue_dir)/CompositionSpan.cc',
      '<(glue_dir)/CompositionSpan.h',
      ...
      '<(glue_dir)/OneShotTimer.cc',
      '<(glue_dir)/OneShotTimer.h',
      '<(glue_dir)/Process.cc',
      '<(glue_dir)/Process.h',
      ...
      '<(glue_dir)/RepeatingTimer.cc',
      '<(glue_dir)/RepeatingTimer.h',
