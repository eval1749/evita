...
TEST_F(NameResolverTest, ClassAnnotation) {
  ...
  EXPECT_EQ(
      ...
      "|  |  |  |  +--Name |VALUE|\n"
      "|  |  +--JsDocText |*/|\n"
      "|  +--Class Class[Map<KEY,VALUE>@1002]\n"
      "|  |  +--Name |Map|\n"
      "|  |  +--ElisionExpression ||\n"
      "|  |  +--ObjectInitializer |{}|\n",
...
TEST_F(NameResolverTest, FunctionAnnotation) {
  EXPECT_EQ(
      ...
      "|  |  |  |  +--Name |VALUE|\n"
      "|  |  +--JsDocText |*/|\n"
      "|  +--Function<Normal> Class[Map<KEY,VALUE>@1003]\n"
      "|  |  +--Name |Map|\n"
      "|  |  +--ParameterList |()|\n"
      "|  |  +--BlockStatement |{}|\n",
...
TEST_F(NameResolverTest, Prototype) {
  EXPECT_EQ(
      ...
      "|  |  |  |  +--Name |T|\n"
      "|  |  +--JsDocText |*/|\n"
      "|  +--Function<Normal> Class[Foo<T>@1003]\n"
      "|  |  +--Name |Foo|\n"
      "|  |  +--ParameterList |()|\n"
      "|  |  +--BlockStatement |{}|\n"
      "+--Annotation\n"
...
TEST_F(NameResolverTest, VarConstructor) {
  ...
  EXPECT_EQ(
      ...
      "|  |  |  |  +--TypeName {class@1001}\n"
      "|  |  |  |  |  +--Name |Foo|\n"
      "|  |  |  +--ReferenceExpression ParameterVar[x@1005]\n"
      "|  |  |  |  +--Name |x|\n"
      "|  |  |  +--JsDocText |*/|\n"
      "|  +--VarStatement\n"
      "|  |  +--BindingNameElement VarVar[foo@1008]\n"
      "|  |  |  +--Name |foo|\n"
