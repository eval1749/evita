  ...
  'targets': [
...

    {
      ...
      'sources': [
        ...
        'dom/events/event_init_dict.cc',
        'dom/events/event_target.cc',
        'dom/events/focus_event.cc',
        'dom/events/focus_event_init_dict.cc',
        'dom/events/form_event.cc',
        'dom/events/form_event_init_dict.cc',
        'dom/events/mouse_event.cc',
        'dom/events/mouse_event_init_dict.cc',
        'dom/events/ui_event.cc',
        'dom/events/ui_event_init_dict.cc',
        'dom/events/window_event.cc',
        'dom/events/window_event_init_dict.cc',
