...
#ifndef EVITA_DOM_COMPONENTS_CLIPBOARD_DATA_TRANSFER_ITEM_LIST_H_
#define EVITA_DOM_COMPONENTS_CLIPBOARD_DATA_TRANSFER_ITEM_LIST_H_
...
#endif  // EVITA_DOM_COMPONENTS_CLIPBOARD_DATA_TRANSFER_ITEM_LIST_H_
