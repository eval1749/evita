...

{
  'variables': {
    ...
    'generated_glue_files': [
      ...
      '<(glue_dir)/DocumentEvent.cc',
      '<(glue_dir)/DocumentEvent.h',
      '<(glue_dir)/DocumentEventInit.cc',
      '<(glue_dir)/DocumentEventInit.h',
      ...
      '<(glue_dir)/FocusEvent.cc',
      '<(glue_dir)/FocusEvent.h',
      '<(glue_dir)/FormEvent.cc',
      '<(glue_dir)/FormEvent.h',
      '<(glue_dir)/Form.cc',
      '<(glue_dir)/Form.h',
      '<(glue_dir)/FormControl.cc',
      '<(glue_dir)/FormControl.h',
      '<(glue_dir)/FormEventInit.cc',
      '<(glue_dir)/FormEventInit.h',
      ...
      '<(glue_dir)/File.cc',
      '<(glue_dir)/File.h',
      '<(glue_dir)/FocusEventInit.cc',
      '<(glue_dir)/FocusEventInit.h',
      '<(glue_dir)/KeyboardEvent.cc',
      '<(glue_dir)/KeyboardEvent.h',
      '<(glue_dir)/KeyboardEventInit.cc',
      ...
      '<(glue_dir)/MutationObserver.cc',
      '<(glue_dir)/MutationObserver.h',
      '<(glue_dir)/MutationObserverInit.cc',
      '<(glue_dir)/MutationObserverInit.h',
      '<(glue_dir)/MutationRecord.cc',
      ...
      '<(glue_dir)/WheelEvent.cc',
      '<(glue_dir)/WheelEvent.h',
