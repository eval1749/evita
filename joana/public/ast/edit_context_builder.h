...
#ifndef JOANA_PUBLIC_AST_EDIT_CONTEXT_BUILDER_H_
#define JOANA_PUBLIC_AST_EDIT_CONTEXT_BUILDER_H_
...
class JOANA_PUBLIC_EXPORT EditContext::Builder {
 public:
  Builder();
  ~Builder();
...
#endif  // JOANA_PUBLIC_AST_EDIT_CONTEXT_BUILDER_H_
