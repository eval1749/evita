...
global.JavaScriptLexer = (function(options) {
  ...
  keywords: (function() {
    var map = Lexer.createKeywords([
      ...
      // Fundamental objects
      'Object', 'Object.create', 'Object.defineProperties',
      ...
      'Function', 'Boolean', 'Symbol', 'Error', 'EvalError', 'InternalError',
      'RangeError', 'ReferenceError', 'StopIteration', 'SyntaxError',
      'TypeError', 'URIError',

      // Numbers and dates
      'Number', 'Number.EPSILON', 'Number.MAX_VALUE', 'Number.MIN_VALUE',
      'Number.NEGATIVE_INFINITY', 'Number.NaN', 'Number.POSITIVE_INFINITY',
      'Number.isFinite', 'Number.isInteger', 'Number.isNaN',
      'Number.parseFloat', 'Number.parseInt', 'Number.toInteger', 'Math',
      'Math.E', 'Math.LN10', 'Math.LN2', 'Math.LOG10E', 'Math.LOG2E', 'Math.PI',
      'Math.SQRT1_2', 'Math.SQRT2', 'Math.abs', 'Math.acos', 'Math.acosh',
      'Math.asin', 'Math.asinh', 'Math.atan', 'Math.atan2', 'Math.atanh',
      'Math.cbrt', 'Math.ceil', 'Math.cos', 'Math.cosh', 'Math.exp',
      'Math.exm1', 'Math.floor', 'Math.fround', 'Math.hypot', 'Math.imul',
      'Math.log', 'Math.log10', 'Math.log1p', 'Math.log2', 'Math.max',
      'Math.min', 'Math.pow', 'Math.random', 'Math.round', 'Math.sign',
      'Math.sin', 'Math.sinh', 'Math.sqrt', 'Math.tan', 'Math.tanh',
      'Math.trunc', 'Date', 'Date.UTC', 'Date.now', 'Date.parse',
      ...
      // Indexed collections
      'Array', 'Array.from', 'Array.isArray', 'Array.of', 'Float32Array',
      'Float64Array', 'Int16Array', 'Int32Array', 'Int8Array', 'Uint16Array',
      'Uint32Array', 'Uint8Array', 'Uint8ClampedArray', 'ParallelArray',

      // Keyed collections
      'Map', 'Set', 'WeakMap', 'WeakSet',

      // Structured data
      'ArrayBuffer', 'DataView', 'JSON', 'JSON.parse', 'JSON.stringify',

      // Control abstraction objects
      'Iterator', 'Generator', 'Promise', 'Promise.all', 'Promise.reject',
      ...
      'Symbol.for', 'Symbol.hasInstance', 'Symbol.isConcatSpreadable',
      'Symbol.iterator', 'Symbol.keyFor', 'Symbol.match', 'Symbol.replace',
      'Symbol.search', 'Symbol.split', 'Symbol.species', 'Symbol.toPrimitive',
    ...
    ['.hasOwnProperty', '.length', '.isPrototypeOf', '.propertyIsEnumerable',
     '.prototype', '.toLocaleString', '.toString', '.unwatch', '.valueOf',
     '.watch',
    ].forEach(function(word) { map.set(word, 'keyword2'); });
    return map;
  })()
});
