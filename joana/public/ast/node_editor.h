...
#ifndef JOANA_PUBLIC_AST_NODE_EDITOR_H_
#define JOANA_PUBLIC_AST_NODE_EDITOR_H_
...
class JOANA_PUBLIC_EXPORT NodeEditor final {
 public:
  NodeEditor();
  ~NodeEditor();
...
#endif  // JOANA_PUBLIC_AST_NODE_EDITOR_H_
