...
#ifndef EVITA_CSS_PROPERTY_SET_H_
#define EVITA_CSS_PROPERTY_SET_H_
...
class PropertySet final {
 public:
  // See "evita/css/property_set_builder.h" for implementation.
  class Builder;
  // See "evita/css/property_set_editor.h" for implementation.
  class Editor;
...
#endif  // EVITA_CSS_PROPERTY_SET_H_
