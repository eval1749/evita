...
class TableView : public CommandWindow_<TableView, views::ContentWindow>,
  ...
  private: virtual const base::string16& GetCellText(
      int row, int column_id) const override;
