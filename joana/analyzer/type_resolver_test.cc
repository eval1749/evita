...
TEST_F(TypeResolverTest, BaseClass) {
  ...
  EXPECT_EQ(
      ...
      "|  |  +--JsDocText |*/|\n"
      "|  +--VarStatement\n"
      "|  |  +--BindingNameElement VarVar[Bar@1004] {Bar@1002}\n"
      "|  |  |  +--Name |Bar|\n"
  ...
  EXPECT_EQ(
      ...
      "+--Annotation\n"
      "|  +--JsDocDocument Class[Foo.Bar@1005]\n"
      "|  |  +--JsDocText |/**|\n"
      "|  |  +--JsDocTag\n"
      "|  |  |  +--Name |@constructor|\n"
      "|  |  +--JsDocTag\n"
      ...
      "{function(new:Foo.Bar@1002):Foo.Bar@1002}\n"
...
TEST_F(TypeResolverTest, ConstructorBaseClass) {
  ...
  EXPECT_EQ(
      ...
      "|  |  +--JsDocText |*/|\n"
      "|  +--VarStatement\n"
      "|  |  +--BindingNameElement VarVar[Bar@1004] {function(new:"
      "Bar@1002):Bar@1002}\n"
      "|  |  |  +--Name |Bar|\n"
...
TEST_F(TypeResolverTest, FunctionInterface) {
  EXPECT_EQ(
      ...
      "|  |  |  |  +--Name |T|\n"
      "|  |  +--JsDocText |*/|\n"
      "|  +--Function<Normal> GenericInterface<T>[Bar@1007]\n"
      "|  |  +--Name |Bar|\n"
      "|  |  +--ParameterList |()|\n"
      "|  |  +--BlockStatement |{}|\n"
      "+--Annotation\n"
      ...
      "|  |  +--JsDocText |\\n"
      " */|\n"
      "|  +--Function<Normal> GenericInterface<U>[Baz@1011]\n"
      "|  |  +--Name |Baz|\n"
      "|  |  +--ParameterList |()|\n"
      "|  |  +--BlockStatement |{}|\n"
      "GenericInterface<U>[Baz@1011]\n"
      "+--BaseClasses\n"
      "|   +--ConstructedInterface<U@1005>[Foo@1013]\n"
      "|   +--ConstructedInterface<U@1005>[Bar@1014]\n",
...
TEST_F(TypeResolverTest, NonNullableType) {
  ...
  EXPECT_EQ(
      ...
      "|  |  +--JsDocText |*/|\n"
      "|  +--VarStatement\n"
      "|  |  +--BindingNameElement VarVar[bar@1004] {Foo@1001}\n"
      "|  |  |  +--Name |bar|\n"
      "|  |  |  +--ElisionExpression ||\n",
      RunOn("/** @constructor */ var Foo;\n"
            "/** @type {!Foo} */ var bar;\n"));
...
TEST_F(TypeResolverTest, NullableType) {
  ...
  EXPECT_EQ(
      ...
      "|  |  +--JsDocText |*/|\n"
      "|  +--VarStatement\n"
      "|  |  +--BindingNameElement VarVar[bar@1004] {%null%|Foo@1001}\n"
      "|  |  |  +--Name |bar|\n"
      "|  |  |  +--ElisionExpression ||\n",
      RunOn("/** @constructor */ var Foo;\n"
            "/** @type {Foo} */ var bar;\n"))
