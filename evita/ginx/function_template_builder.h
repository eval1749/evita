...
#ifndef EVITA_GINX_FUNCTION_TEMPLATE_BUILDER_H_
#define EVITA_GINX_FUNCTION_TEMPLATE_BUILDER_H_

#include <type_traits>

#include "evita/ginx/function_template.h"
BEGIN_V8_INCLUDE
...
#endif  // EVITA_GINX_FUNCTION_TEMPLATE_BUILDER_H_
