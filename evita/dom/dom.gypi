...
# found in the LICENSE file.
{
  ...
  'variables': {
    ...
    'js_lib_files': [
      ...
      'bracket.js',
      'commander.js',
      'text/text_document.js',
      'text/text_document_file_io.js',
      'text/text_document_file_load.js',
      'text/text_document_file_save.js',
      'editor.js',
      ...
      'windows/text_document_state.js',
      'windows/point.js',
      'windows/rect.js',
      'windows/tab_data.js',
      ...
      'console.js',
      'commands/text_document_list.js',
  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'converter.cc',
        'text/text_document.cc',
        'text/text_document_set.cc',
