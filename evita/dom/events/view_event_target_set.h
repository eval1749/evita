...
//////////////////////////////////////////////////////////////////////
//
// EventTarget::ViewEventTargetSet
//
...
class ViewEventTargetSet : public common::Singleton<ViewEventTargetSet> {
  ...
  private: std::unordered_map<EventTargetId, gc::WeakPtr<ViewEventTarget>> map_;
  ...
  public: ViewEventTarget* Find(EventTargetId event_target_id) const;
  public: EventTargetId Register(ViewEventTarget* event_target);
