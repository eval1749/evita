...
#ifndef EVITA_TEXT_MODELS_BUFFER_MUTATION_OBSERVER_H_
#define EVITA_TEXT_MODELS_BUFFER_MUTATION_OBSERVER_H_
...
#endif  // EVITA_TEXT_MODELS_BUFFER_MUTATION_OBSERVER_H_
