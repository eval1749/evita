...
#ifndef EVITA_TEXT_PAINT_ROOT_INLINE_BOX_LIST_PAINTER_H_
#define EVITA_TEXT_PAINT_ROOT_INLINE_BOX_LIST_PAINTER_H_
...
#endif  // EVITA_TEXT_PAINT_ROOT_INLINE_BOX_LIST_PAINTER_H_
