...

{
  'variables': {
    ...
    'generated_glue_files': [
      ...
      '<(glue_dir)/v8_glue_TextDocumentEvent.cc',
      '<(glue_dir)/v8_glue_TextDocumentEvent.h',
      '<(glue_dir)/v8_glue_TextDocumentEventInit.cc',
      '<(glue_dir)/v8_glue_TextDocumentEventInit.h',
      '<(glue_dir)/v8_glue_TextDocumentWindow.cc',
      '<(glue_dir)/v8_glue_TextDocumentWindow.h',
