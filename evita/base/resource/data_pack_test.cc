...
const char kSamplePakContents[] = {
    0x05, 0x00, 0x00, 0x00,              // file version
    0x01, 0x00, 0x00, 0x00,              // encoding
    0x04, 0x00,                          // number of resource entry
    0x00, 0x00,                          // number of alias entry
    0x01, 0x00, 0x2A, 0x00, 0x00, 0x00,  // index entry 1
    0x04, 0x00, 0x2A, 0x00, 0x00, 0x00,  // index entry 4
    0x06, 0x00, 0x36, 0x00, 0x00, 0x00,  // index entry 6
    0x0a, 0x00, 0x42, 0x00, 0x00, 0x00,  // index entry 10
    0x00, 0x00, 0x42, 0x00, 0x00, 0x00,  // extra entry for the size of last
    't',  'h',  'i',  's',  ' ',  'i',  's', ' ', 'i', 'd', ' ', '4',
    't',  'h',  'i',  's',  ' ',  'i',  's', ' ', 'i', 'd', ' ', '6'};
