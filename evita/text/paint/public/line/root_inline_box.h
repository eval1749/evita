...
#ifndef EVITA_TEXT_PAINT_PUBLIC_LINE_ROOT_INLINE_BOX_H_
#define EVITA_TEXT_PAINT_PUBLIC_LINE_ROOT_INLINE_BOX_H_
...
#endif  // EVITA_TEXT_PAINT_PUBLIC_LINE_ROOT_INLINE_BOX_H_
